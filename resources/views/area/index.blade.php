...
@section('content')
    <div class="container-fluid">
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-lg-7">
                        <div class="form-floating mb-3">
                            <label for="floatingInput" class="mb-0 text-dark">Area name</label>
                            <input type="text" class="form-control" id="floatingInput" name="name"
                                placeholder="Area name" required value="{{ old('name') }}">
                            @error('name')
        ...
        <div class="card shadow rounded-12 border-0 mt-3">
            <div class="card-header d-flex justify-content-between bg-primary py-2 align-items-center">
                <h2 class="card-title m-0 text-white">{{ __('Area Zone') }}</h2>
            </div>
