...
@section('container')
    ...
    <div class="buttons">
        <a href="{{ route('LaravelInstaller::environmentWizard') }}" class="button button-wizard">
            <i class="fa fa-sliders fa-fw" aria-hidden="true"></i> {{ __('installer_messages.environment.menu.wizard-button') }}
        </a>
        {{-- <a href="{{ route('LaravelInstaller::environmentClassic') }}" class="button button-classic">
            <i class="fa fa-code fa-fw" aria-hidden="true"></i> {{ __('installer_messages.environment.menu.classic-button') }}
        </a> --}}
    </div>
