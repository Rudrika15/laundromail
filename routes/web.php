...
use App\Http\Controllers\API\ReferAndEarn\ReferAndEarnController;
...
Route::controller(ReferAndEarnController::class)->group(function () {
    Route::get('/refer-and-earn/points', 'viewPoints')->name('refer.point.index');
    Route::get('/refer-and-earn/points/edit/{id?}', 'editPoints')->name('refer.point.edit');
    Route::post('/refer-and-earn/points/update', 'updatePoints')->name('refer.point.update');
});
